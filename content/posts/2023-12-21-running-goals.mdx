...
There are common protocols to estimate VO2max, such as the [Cooper test](https://en.wikipedia.org/wiki/Cooper_test) or the Vameval test (particaularly popular in France for football).
...
I later realised that other indicators were summarising my running fitness better.
...
We can now interprete those curves. For example, Men world record atheles are above VDOT 80 while Women world record athletes have a VDOT of 75.
...
When you think about it, finishing a first Half-Marathon in under 1h40 is ambitious, but looking at the data here, I think it's a difficult and specific goal.
I seem to already have a VDOT above 45, and I have a few months to train and improve my fitness further, specifically working on longer distance runs and making sure my VDOT score translates for bigger distances.
