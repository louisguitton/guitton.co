...
<figure>
    <img src="/images/dbt-search/jtbd.png"
         alt="Jobs to be Done"/>
...
<figure>
    <img src="/images/dbt-search/amundsen_logo.png"
         alt="Amundsen logo"
         className="w-[500px]"/>
    <figcaption>Amundsen and other heavyweight tools are the go-to solution for data discovery</figcaption>
</figure>
...
<figure>
    <img src="/images/dbt-search/amundsen.png"
         alt="Amundsen logo"/>
    <figcaption>Architecture of your friendly neighbourhood metadata engine</figcaption>
</figure>
...
<figure>
    <img src="/images/dbt-search/amundsen_features.png"
         alt="Amundsen features"
         className="h-[800px]"/>
    <figcaption>Taxonomy of 10 features from metadata engines, cost opinions are my own</figcaption>
</figure>
...
<em background-color="#4c6ef5" color="white">Features to Understand</em> from the above diagram. So **what is missing from dbt Docs to rival with Amundsen**? Only a way
to sublime the work that is already happening in your dbt repository. And that is Search.

<figure>
    <img src="/images/dbt-search/algolia_logo.png"
         alt="Algolia logo"
         className="w-[500px]"/>
    <figcaption>Algolia market themselves as a 'flexible search platform'</figcaption>
</figure>
...
- dbt artifacts (_See my post on [how to parse dbt artifacts](/posts/2020-12-20-dbt-artifacts.md#available-data-in-dbt-artifacts) _)
- git metadata
...
from Paolo Melchiorre](/posts/2020-07-27-europython2020#paolo-melchiorre) advocating for using good-old
...
<figure>
    <img src="/images/dbt-search/search.png"
...
a PageRank-like algorithm (degree centrality [as shown in my previous post](/posts/2020-12-20-dbt-artifacts.md#example-application-2-compute-model-centrality-with-networkx)).
...
<figure>
    <img src="/images/dbt-search/bad_f_vegemite-cheese-jaffle.jpg"
        alt="Structuring Documents for Search"
        className="h-[200px]"/>
