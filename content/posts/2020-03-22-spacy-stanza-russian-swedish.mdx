...
<blockquote className="twitter-tweet" data-lang="en">
    <p lang="en" dir="ltr">Now also available for your spaCy pipeline: <br></br><br></br>spacy-stanza (formerly spacy-stanfordnlp)
        integrates Stanza by <a href="https://twitter.com/stanfordnlp?ref_src=twsrc%5Etfw">@StanfordNLP</a> – with
        support for more languages and NER 🚀<a href="https://t.co/vAvAIXojNm">https://t.co/vAvAIXojNm</a> <a
