...
categories:
  - Code
image: /images/fastapi-monitoring/fastapi.png
series:
  - top posts
---
...
![4 steps of monitoring](/images/fastapi-monitoring/4_steps_monitoring.png "The 4 components of monitoring")
...
![monitoring backend](/images/fastapi-monitoring/monitoring_backend.png "The 2 components of the monitoring backend")
...
[There seems to be support for ASGI in ddtrace](https://pypi.datadoghq.com/trace/docs/web_integrations.html?highlight=asgi#asgi)
...
![opentelemetry jaeger](/images/fastapi-monitoring/opentelemetry_jaeger.png "Example instrumentation")
...
![opentelemetry datadog](/images/fastapi-monitoring/opentelemetry_datadog.png "Example instrumentation")
