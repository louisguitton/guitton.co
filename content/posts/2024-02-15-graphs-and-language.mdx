...
And soon, two approaches were in front of us: Fine Tuning or Retrieval-Augmented Generation (RAG).
...
NebulaGraph introduces Graph RAG, which is a retrieval system based on a Graph Database (which they conveniently sell).
...
This snippet supposes you have Ollama serving a model called "mistral" and a Neo4j database running locally.
