...
<div className="grid grid-cols-2 gap-x-4">
  <img
    src="/images/mecatronics/snakeboard_model.png"
    alt="The simplified model of a snakeboard"
    className="h-12"
  />
  <img
    src="/images/mecatronics/snakeboard_assemblage.jpg"
    alt="Assemblage of snakeboard pieces"
    className="h-12"
  />
  {/* for some reason col-span-2 in tailwindCSS doesn't work */}
  <img
    src="/images/mecatronics/snakeboard_cad.jpg"
    alt="CAD software"
    className="h-12"
